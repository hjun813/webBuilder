          ...
          >
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="type" className="block text-sm font-medium text-slate-700 mb-1">관심 서비스</label>
                  <select id="type" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all bg-white text-slate-700">
                    <option>Light (1페이지/개인용)</option>
                    <option>Business (5페이지/소상공인)</option>
                    <option>Custom (특수기능 개발)</option>
                    <option>기타 문의</option>
                  </select>
                </div>
                <div>
